...
public:
    enum Level : quint8 { Debug, Info, Warninig, Error, Off, count };
    Q_ENUM(Level)
...
#if defined(LOG_Debug) || defined(LOG_Info) || defined(LOG_Warning) || defined(LOG_Error)          \
        || defined(LOG_MESSAGE_MANUALLVL)
#    error "^^ redefinition"
#endif
