...
public:
    PropertyGenerator(T &obj) : _index(T::staticMetaObject.propertyOffset()), _obj(obj) { }
    ...
    operator bool() const { return _index < T::staticMetaObject.propertyCount(); }


    QVariant read() const { return T::staticMetaObject.property(_index).readOnGadget(&_obj); }
    bool write(QVariant const &val)
    {
        return T::staticMetaObject.property(_index).writeOnGadget(&_obj, val);
    }

    QMetaProperty property() const { return T::staticMetaObject.property(_index); }
};
